    ...
    <>
      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-gray-200 p-6">
        <h1 className="mb-4 text-center text-4xl font-bold text-gray-700">
          Appointment Form - Dr. Harris
        </h1>
        <h2 className="mb-8 text-center text-xl font-medium text-gray-600">
          Submit the form below to schedule an appointment with Dr. Harris. Our
          office will contact you to confirm your appointment. Please allow us
          24 hours to respond. Thank you!
        </h2>
