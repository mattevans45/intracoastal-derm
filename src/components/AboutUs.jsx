...
const AboutUs = () => {
  ...
  return (
    ...
    >
      <motion.div className="mx-2 py-5 text-zinc-700">
        <div className="rounded-xl bg-white py-10 shadow-md">
          <motion.h2
            key={"header"}
            variants={itemVariants}
            className="mb-8 rounded-xl bg-white py-2 text-center text-3xl font-bold text-zinc-700"
          >
            Why Choose Intracoastal Dermatology and Skin Surgery?
          </motion.h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-6 text-zinc-800 antialiased ">
            {[
              {
                title: "Expert Care",
              ...
              <motion.div key={index} variants={itemVariants} className="text-center bg-zinc-100/80 p-2 rounded-lg">
