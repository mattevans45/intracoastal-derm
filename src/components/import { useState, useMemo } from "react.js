...
const Navbar = () => {
  ...
  return (
    ...
    sticky top-0 z-50 mx-auto flex flex-col bg-white/90 bg-clip-text mix-blend-normal
    <>
      <div className="sticky z-30 top-0 mx-auto flex flex-col bg-stone-100/90 backdrop-saturate-125 backdrop-blur-[2.5px]">
        {!mobileMenuOpen && (
          <>
            <AlertBar />
            <ContactBar />
            <motion.header
              ...
              className="navbar sticky z-[49] bg-blend-darken px-2 shadow md:pr-3"
            >
              <nav
