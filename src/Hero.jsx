    ...
    <>
      <div className="relative isolate px-6  lg:px-8">
        <div
          ...
          aria-hidden="true"
        >
          <div className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#c7c7c7] to-[#1670e6] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" />
        </div>
        <div className="mx-auto max-w-2xl  sm:py-48 md:py-20 lg:py-20">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Now accepting new patients.
              <Link to="/" className="font-semibold px-2 text-[#30648B]">
          ...
          <div className="text-center">
            <h1 className="text-4xl sm:mt-14 mt-5 font-bold text-[#4d4d4d] drop-shadow-2xl font-poppins tracking-tighter h-40 z-5  sm:text-6xl">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <Link
                ...
                className="text-sm font-semibold w-30 h-fit leading-6 hover:bg-slate-200 text-gray-800"
              >
      ...
      <section className="bg-white ">
        <div className="relative overflow-hidden bg-white text-center">
          <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed">
            <div className="flex lg:mt-32 sm:mt-24 md:mt-20 lg:text-pretty lg:text-center lg:items-around  lg:justify-evenly h-full md:flex md:items-baseline items-between justify-center">
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <h1 className="sm:text-3xl text-2xl font-medium font-poppins text-center text-gray-900 mb-20">
            Intracoastal Dermatology
            <p className="hidden md:block sm:block">The best feeling is feeling good</p>
          </h1>
          ...
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            <div className="p-4 md:w-1/3 flex">
              ...
              <div className="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-blue-900 mb-4 flex-shrink-0">
                <GiSyringe className="h-8 w-7 font-white bg-transparent" />
              </div>
              <div className="flex-grow pl-6">
                ...
                <Link
                  ...
                  className="mt-3 text-[#30648B] inline-flex items-center"
                >
                  Learn More
                  <svg
                    fill="none"
